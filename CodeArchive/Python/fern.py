...
#        self.update_button.setFocus()
    ...
    def scan_process2_thread(self):
        ...
        if bool(variables.xterm_setting):
            wep_display_mode = 'x-terminal-emulator -T "FERN (WEP SCAN)" -geometry 100 -e'  # if True or if xterm contains valid ascii characters
        else:
            wep_display_mode = ''
    ...
    def scan_process2_thread1(self):
        ...
        if bool(variables.xterm_setting):  # if True or if xterm contains valid ascii characters
            wpa_display_mode = 'x-terminal-emulator -T "FERN (WPA SCAN)" -geometry 100 -e'
        else:
            wpa_display_mode = ''
